...
public class FunWithExceptions
{
		...
		StringTooLongException, NoEvenNumberException
	{
		...
		final int MAX = 20;
		int num;
		String input, name = "Tesfalem Tekie";
		...
		Random gen = new Random();
			...
			// be caught if raised
		StringTooLongException lengthException = new 
				StringTooLongException ("String has too many characters");
		
		NoEvenNumberException noEvenException = new
				NoEvenNumberException ("No even numbers are allowed");
